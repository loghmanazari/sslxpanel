...
<VirtualHost *:$serverPort>
    ...
    ServerAdmin webmaster@localhost
    DocumentRoot /var/www/html/cp/jahan
    ...
    <Directory '/var/www/html/cp/jahan'>
    AllowOverride All
    </Directory>
...
sudo service apache2 restart
chown www-data:www-data /var/www/html/cp/jahan/* &
wait
...
chown apache:apache /var/www/html/cp/jahan/* &
wait
...
wait
sudo sed -i "s/22/$port/g" /var/www/html/cp/jahan/Config/database.php &
wait
sudo sed -i "s/adminuser/$adminusername/g" /var/www/html/cp/jahan/Config/database.php &
wait
sudo sed -i "s/adminpass/$adminpassword/g" /var/www/html/cp/jahan/Config/database.php &
wait
sudo sed -i "s/SERVERUSER/$adminusername/g" /var/www/html/cp/jahan/Libs/sh/killusers.sh &
wait
sudo sed -i "s/SERVERPASSWORD/$adminpassword/g" /var/www/html/cp/jahan/Libs/sh/killusers.sh &
wait
curl -u "$adminusername:$adminpassword" "$protcohttp://${defdomain}:$sshttp/reinstall"
wait
crontab -r
wait
chmod 777 /var/www/html/cp/jahan/Libs/sh/kill.sh
wait
multiin=$(echo "$protcohttp://${defdomain}:$sshttp/fixer&jub=multi")
cat > /var/www/html/cp/jahan/Libs/sh/kill.sh << ENDOFFILE
#!/bin/bash
#By Alireza
...
ENDOFFILE
wait
sudo sed -i 's/(bbh/$(curl -v -H "A: B"/' /var/www/html/cp/jahan/Libs/sh/kill.sh
wait
sudo sed -i 's/cmd/$cmd/' /var/www/html/cp/jahan/Libs/sh/kill.sh
wait
sudo sed -i 's/1i/$i/' /var/www/html/cp/jahan/Libs/sh/kill.sh
wait
sudo sed -i 's/((/$((/' /var/www/html/cp/jahan/Libs/sh/kill.sh
wait
chmod 777 /var/www/html/cp/jahan/storage
wait
chmod 777 /var/www/html/cp/jahan/storage/log
wait
chmod 777 /var/www/html/cp/jahan/storage/backup
wait
chmod 777 /var/www/html/cp/jahan/Config/database.php
wait
chmod 777 /var/www/html/example/index.php
wait
chmod 777 /var/www/html/cp/jahan/Config/define.php
wait
chmod 777 /var/www/html/cp/jahan/Libs
wait
chmod 777 /var/www/html/cp/jahan/Libs/sh
wait
chmod 777 /var/www/html/cp/jahan/Libs/sh/stunnel.sh
wait
chmod 777 /etc/stunnel/stunnel.conf
wait
chmod 777 /var/www/html/cp/jahan/assets/js/config.js
wait
if [ "$xport" != "" ]; then
pssl=$((xport+1))
sudo sed -i "s/$xport/$serverPort/g" /var/www/html/cp/jahan/Config/define.php &
wait
sudo sed -i "s/$pssl/$serverPortssl/g" /var/www/html/cp/jahan/Config/define.php &
fi
(crontab -l | grep . ; echo -e "* * * * * /var/www/html/cp/jahan/Libs/sh/kill.sh") | crontab -
